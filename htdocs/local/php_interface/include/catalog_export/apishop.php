...
/*if ($fp = @fopen($_SERVER["DOCUMENT_ROOT"].(COption::GetOptionString("catalog", "export_default_path", "/upload/"))."/apishop.php", 'wb'))
{
	@fwrite($fp, $strAll);
	@fclose($fp);
} */
...
$strYandexPath = str_replace('//','/',$strExportPath."/apishop.php");
