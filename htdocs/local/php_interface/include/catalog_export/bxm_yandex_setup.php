...
$MESS['CET_WORD_NAME_SKIP'] = 'Пропускать товары в названии которых присутствуют слова, через запятую';
$MESS['CET_PRODUCT_DESCRIPTION_ADD'] = 'Общее для всех товаров дополнительное описание. Поддерживается автозамена #NAME#. Учтите, Яндекс допускает длину описания товара не более 512 символов.';
?>
<?
...
if (($ACTION == 'EXPORT_EDIT' || $ACTION == 'EXPORT_COPY') && $STEP == 1)
{
    ...
    // пропускать со словами в имени товара
    if (isset($arOldSetupVars['SKIP_GOODS_NAME_WORDS']))
		$SKIP_GOODS_NAME_WORDS = $arOldSetupVars['SKIP_GOODS_NAME_WORDS'];
   // дополнительное описание товара
   if (isset($arOldSetupVars['PRODUCT_DESCRIPTION_ADD']))
		$PRODUCT_DESCRIPTION_ADD = $arOldSetupVars['PRODUCT_DESCRIPTION_ADD'];
...
function setDetailData(data)
{
	BX('XML_DATA').value = data;
			...
			<?endif;?>
            <!-- BXM добавим поле для ввода слов, при наличии которых в названии товара, он будет пропускаться -->
                <tr>
					<td width="100%" valign="top">
						<font class="text"><b><?echo GetMessage("CET_WORD_NAME_SKIP");?></b></font><br />
						<textarea rows="10" style="width: 100%;"  name="SKIP_GOODS_NAME_WORDS" ><?echo htmlspecialcharsbx($SKIP_GOODS_NAME_WORDS) ?></textarea>
						<br />
					</td>
				</tr>
                
                <!-- общее для всех товаров описание -->
                
                <tr>
					<td width="100%" valign="top">
						<font class="text"><b><?echo GetMessage("CET_PRODUCT_DESCRIPTION_ADD");?></b></font><br />
						<textarea rows="10" style="width: 100%;"  name="PRODUCT_DESCRIPTION_ADD" ><?echo htmlspecialcharsbx($PRODUCT_DESCRIPTION_ADD) ?></textarea>
						<br />
					</td>
				</tr>
            <!-- /BXM -->
			<tr>
				<td width="100%" valign="top">
					...
					<input type="hidden" name="SETUP_FIELDS_LIST" value="V,IBLOCK_ID,SETUP_SERVER_NAME,SETUP_FILE_NAME,XML_DATA,SKIP_GOODS_NAME_WORDS,PRODUCT_DESCRIPTION_ADD" />
