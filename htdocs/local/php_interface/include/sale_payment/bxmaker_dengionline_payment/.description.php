...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/bxmaker.dengionline/payment/bxmaker_dengionline_payment/.description.php')) {
	include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/bxmaker.dengionline/payment/bxmaker_dengionline_payment/.description.php');
}
?>