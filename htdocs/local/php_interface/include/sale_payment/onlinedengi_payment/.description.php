...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/rarusspb.onlinedengi/payment/onlinedengi_payment/.description.php')) {
	include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/rarusspb.onlinedengi/payment/onlinedengi_payment/.description.php');
}
