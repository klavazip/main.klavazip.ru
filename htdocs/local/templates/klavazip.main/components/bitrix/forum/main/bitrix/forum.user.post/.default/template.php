...
$APPLICATION->SetPageProperty("title",$arResult['USER']["LOGIN"].' (все сообщения)');
$APPLICATION->SetTitle($arResult['USER']["LOGIN"].' (все сообщения)');
$arResult['USER']["SHOW_ABC"]=$arResult['USER']["LOGIN"];$arResult['USER']["~SHOW_ABC"]=$arResult['USER']["LOGIN"];
$arResult['USER']["NAME"]=$arResult['USER']["LOGIN"];$arResult['USER']["~NAME"]=$arResult['USER']["LOGIN"];$arResult['USER']["LAST_NAME"]=$arResult['USER']["LOGIN"];$arResult['USER']["~LAST_NAME"]=$arResult['USER']["LOGIN"];
