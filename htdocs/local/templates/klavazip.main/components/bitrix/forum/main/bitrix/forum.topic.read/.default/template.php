...
<?
/*$arResult["MESSAGE_LIST"]<br/><pre><?var_dump($arResult["MESSAGE_LIST"]);?></pre><br/>
$message<br/><pre><?var_dump($message);?></pre><br/>
$arParams<br/><pre><?var_dump($arParams);?></pre><br/>
$this<br/><pre><?var_dump($this);?></pre><br/><?*/

$uar=array('AUTHOR');
foreach($arResult["MESSAGE_LIST"] as $k=>$v)
	foreach($uar as $u)
	{
		$rsUser132 = CUser::GetByID($v[$u."_ID"]);
	   $arUser123 = $rsUser132->Fetch();
	   $arResult["MESSAGE_LIST"][$k][$u.'_NAME']= $arUser123['LOGIN'];
	   $arResult["MESSAGE_LIST"][$k]["FOR_JS"][$u."_NAME"]=$arUser123['LOGIN'];
	   $res["~".$u."_NAME"]=  $arUser123['LOGIN'];
	}
