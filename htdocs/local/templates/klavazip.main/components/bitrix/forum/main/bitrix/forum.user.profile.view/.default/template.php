<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?><?$arResult["SHOW_NAME"]=$arResult['USER']["LOGIN"];$arResult["~SHOW_NAME"]=$arResult['USER']["LOGIN"];
...
$APPLICATION->SetPageProperty("title",$arResult['USER']["LOGIN"]);
