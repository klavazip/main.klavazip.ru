...
if (!$this->__component->__parent || empty($this->__component->__parent->__name))
{
	...
	//$APPLICATION->AddHeadScript('/bitrix/forum/main/bitrix/forum.post_form/.default/script_deferred.js');
	 
	//$APPLICATION->AddHeadString('<script type="text/javascript" src="/bitrix/forum/main/bitrix/forum.post_form/.default/script_deferred.js"></script>', true);
};
...
<?//=ForumAddDeferredScript('/bitrix/forum/main/bitrix/forum.post_form/.default/script_deferred.js');?>
