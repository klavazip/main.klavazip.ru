...
?>
	<div class="forum-new-post">
		<noindex><a href="<?=$arResult["URL"]["TOPIC_NEW"]?>" title="<?=GetMessage("F_NEW_TOPIC_TITLE")?>"><span><?=GetMessage("F_NEW_TOPIC")?></span></a></noindex>
	</div>
<?
endif;
?>
...
$uar=array('LAST_POSTER','USER_START','ABS_LAST_POSTER');
foreach($uar as $u)
{
	$rsUser132 = CUser::GetByID($res[$u."_ID"]);
