...
<div class="boxMain">
	...
	<div class="boxMainCont pad">
		<div class="boxMainFormOrder">
			
				<div class="leftFormOrder">
					<h3>Для вернувшихся покупателей</h3>
					...
					<form method="post" action="<?= $arParams["PATH_TO_ORDER"] ?>" name="order_auth_form">
						...
						<input type="submit" class="buttonBuy" value="Далее"/>
						<input type="hidden" name="do_authorize" value="Y">
						<a href="/aut/forgotpasswd/" class="forget">Забыли пароль?</a>
						<div class="clear"></div>	
					</form>
				</div>
				
				
				<div class="rightFormOrder">
					<h3>Для новых покупателей</h3>							
					<form method="post" action="<?= $arParams["PATH_TO_ORDER"]?>" name="order_reg_form">
						<?=bitrix_sessid_post()?>
						<label>Логин <span>*</span></label>
						<div class="blockInputform">
							<input  type="text"  name="NEW_LOGIN" value="<?=$arResult["POST"]["NEW_LOGIN"]?>"/>								
						</div>							
						<?=bitrix_sessid_post()?>
						<label>Имя <span>*</span></label>
						<div class="blockInputform">
							<input  type="text"  name="NEW_NAME" value="<?=$arResult["POST"]["NEW_NAME"]?>"/>								
						</div>							
						<label>Фамилия <span>*</span></label>
						<div class="blockInputform">
							<input  type="text"  name="NEW_LAST_NAME" value="<?=$arResult["POST"]["NEW_LAST_NAME"]?>"/>								
						</div>		
						<label>Электронная почта <span>*</span></label>
						<div class="blockInputform">
							<input  type="text"  name="NEW_EMAIL" value="<?=$arResult["POST"]["NEW_EMAIL"]?>"/>								
						</div>		
						<label>Пароль <span>*</span></label>
						<div class="blockInputform">
					...
					<div class="clear"></div>
						...
						<div class="boxCapcha">
							<div class="imgCapcha">
								<img src="img/img_capcha.jpg"   alt="" />
								<a href="#">Обновить</a>
							</div>									
							<div class="blockInputform">
