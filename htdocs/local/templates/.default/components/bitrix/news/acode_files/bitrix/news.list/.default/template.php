...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<p class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<br/>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
		<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><b style="font-size:24px;color:#ff5252;font-weight: bold;"><?echo $arItem["NAME"]?></b></a><br />
			<?else:?>

			<b style="font-size:24px;color:#ff5252;font-weight: bold;"><?echo $arItem["NAME"]?></b><br />
			<?endif;?>
		<br/>
		<?endif;?>
...
if (count($arProperty['FILE_VALUE'])>0){
