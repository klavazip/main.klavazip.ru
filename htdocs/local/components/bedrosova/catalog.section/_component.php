...
if($this->StartResultCache(false, array($arrFilter, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()), $arNavigation)))
{
	...
	//$arrFilter['PROPERTY_diagonal_VALUE'] = array('14,0"', '15,6"');//array('882');
	//$arrFilter['PROPERTY_diagonal'] = array(882, 883);//array('882');
	
	
	//diagonal
	
	//echo '<pre>', print_r(array_merge($arrFilter, $arFilter, $ob_KlavaFilter->getFiltetForGetList())).'</pre>';
