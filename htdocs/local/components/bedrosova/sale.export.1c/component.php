						...
						if($value["#"][GetMessage("CC_BSC1_OPERATION")][0]["#"] == GetMessage("CC_BSC1_ORDER"))
						{
							...
							if($orderInfo = CSaleOrder::GetByID($orderId))
							{
								...
								else
								{
									...
									{
										arraytofile($orderInfo,$_SERVER['DOCUMENT_ROOT']."/upload/Paid1COrderInfo.txt", "orderInfo");
									
										if($orderInfo["PAYED"]=="N"){
											/*if ($orderInfo['PAY_SYSTEM_ID']==24 || $orderInfo['PAY_SYSTEM_ID']==25 || $orderInfo['PAY_SYSTEM_ID']==28 || $orderInfo['PAY_SYSTEM_ID']==29 || $orderInfo['PAY_SYSTEM_ID']==30 || $orderInfo['PAY_SYSTEM_ID']==33){
									...
									{
										arraytofile($orderInfo,$_SERVER['DOCUMENT_ROOT']."/upload/Delivery1COrderInfo.txt", "orderInfo");
