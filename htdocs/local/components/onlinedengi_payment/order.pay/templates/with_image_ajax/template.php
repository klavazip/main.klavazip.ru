...
if(empty($arResult['ERRORS'])) {
	?><div id="onlinedengi_ajax"><div class="onlinedengi-form-block"><div class="onlinedengi-form-block-pad"><?
		if(empty($arResult['FIELDS']['mode_type'])) {
			...
			?><form method="post" action="http://www.onlinedengi.ru/wmpaycheck.php"><?
	...
	<script type="text/javascript">
		$(document).ready(function(){
			var ajax_change = function(){
				...
				$(".onlinedengi-form-block input[name='mode_type']").change(function(){

					$.post("/bitrix/tools/onlinedengi_ajax.php",
					{
					...
					function(data){
						$("#onlinedengi_ajax").empty();
						$("#onlinedengi_ajax").append(data);
						

						$(".onlinedengi-href a").click(function(){
							$.post("/bitrix/tools/onlinedengi_ajax.php",
							{
