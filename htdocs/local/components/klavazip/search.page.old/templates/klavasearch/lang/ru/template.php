...
$MESS['T_SEARCH_ITEM_BUY_BTN_LABLE'] = 'купить';
$MESS['T_SEARCH_NOTICE'] = 'уведомить меня о наличии';
$MESS['T_SEARCH_QUANTITY_LABEL'] = 'Наличие';
$MESS['T_SEARCH_QUANTITY'] = 'Всего #QUANT# шт.';
$MESS['T_SEARCH_COMPARE'] = 'Сравнить';
$MESS['T_SEARCH_TO_WISHLIST'] = 'В желаемые';
$MESS['T_SEARCH_ITEM_QUANTITY_ZERO'] = 'Нет в наличии';
$MESS['T_SEARCH_ARTICLE'] = 'Артикул: ';

$MESS['CT_BSP_SEARCH_RESULT_COUNT'] = ' #COUNT# результатов';
$MESS['CT_BSP_SEACH_LABEL'] = 'Поиск';
$MESS['CATALOG_ITEM_ANALOGI_INFO_LABEL'] = 'Аналоги:';
