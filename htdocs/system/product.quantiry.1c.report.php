...
else
{
	...
	else
	{
		if($data = file_get_contents($s_TmpName))
		{
			...
			{
				$ar_XMLElement[] = array(
					'XML_ID' 		=> $ar_Value['Value'][1]['@value'],
					'COUNT' 		=> intval($ar_Value['Value'][2]['@value']),
				);
			}
			...
			arraytofile($ar_Result['row'], $_SERVER['DOCUMENT_ROOT']."/___dev/111111111111.txt" );
			...
			echo '	<column>
						<Name>Реквизит1</Name>
						<ValueType><Type xmlns:d4p1="http://v8.1c.ru/8.1/data/enterprise/current-config">d4p1:CatalogRef.Номенклатура</Type>
						<Type>Null</Type></ValueType>
						<Title>Номенклатура</Title><Width>25</Width></column>
					<column>
						<Name>Реквизит2</Name>
						<ValueType><Type>Null</Type><Type>xs:decimal</Type><NumberQualifiers><Digits>38</Digits><FractionDigits>3</FractionDigits><AllowedSign>Any</AllowedSign>
						</NumberQualifiers></ValueType>
						<Title>ОстатокВ1С</Title>
						<Width>38</Width>
					</column>
					<column><Name>Реквизит3</Name><ValueType><Type>Null</Type><Type>xs:decimal</Type><NumberQualifiers><Digits>38</Digits><FractionDigits>3</FractionDigits><AllowedSign>Any</AllowedSign></NumberQualifiers></ValueType>
			<Title>ОстатокНаСайте</Title><Width>38</Width></column>';
